...
INCLUDE_ALL_LANGUAGES = -DINCLUDE_LOJBAN_MONERO_MNEMONIC=1 -DINCLUDE_ESPERANTO_MONERO_MNEMONIC=1 -DINCLUDE_PORTUGUESE_MONERO_MNEMONIC=1 -DINCLUDE_DUTCH_MONERO_MNEMONIC=1
INCLUDED_LANGUAGES_ALL_BUILDS = -DINCLUDE_DUTCH_MONERO_MNEMONIC=1
CXXFLAGS = $(INCLUDE) -DUSE_MONERO=1 -DUSE_KECCAK=1 $(COLOR_DEFS) $(DIMENSIONS_DEFS) $(INCLUDED_LANGUAGES_ALL_BUILDS)
CCFLAGS = $(INCLUDE) -DUSE_MONERO=1 -DUSE_KECCAK=1 $(BYTE_ORDER) $(INCLUDED_LANGUAGES_ALL_BUILDS)

CLI_MAKE_TARGET = $(findstring $(MAKECMDGOALS), cli)
ifeq ($(CLI_MAKE_TARGET), cli)
	CXXFLAGS += -std=c++11 -pthread -DUTF8_COMPAT_BUILD=1 -DINCLUDE_LOJBAN_MONERO_MNEMONIC=1 -DINCLUDE_ESPERANTO_MONERO_MNEMONIC=1 -DINCLUDE_PORTUGUESE_MONERO_MNEMONIC=1
	CCFLAGS += -DINCLUDE_LOJBAN_MONERO_MNEMONIC=1 -DINCLUDE_ESPERANTO_MONERO_MNEMONIC=1 -DINCLUDE_PORTUGUESE_MONERO_MNEMONIC=1
endif
ifeq ($(findstring $(MAKECMDGOALS), tests), tests)
	CXXFLAGS += $(INCLUDE_ALL_LANGUAGES)
	CCFLAGS += $(INCLUDE_ALL_LANGUAGES)
endif
